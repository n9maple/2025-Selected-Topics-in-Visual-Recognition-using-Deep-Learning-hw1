...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_data_dir", type=str, default="data/test", help="The directory where the test data are")
    parser.add_argument("--model_path", type=str, default="./save_model/model_epoch19.pth", help="The path of the model weight")
    parser.add_argument("--save_dir", type=str, default="./", help="Save prediction result to the directory")
    parser.add_argument("--nodropout", action="store_true", help="Delete the dropout layer if on (need to be the same as traing model)")
    parser.add_argument("--device", type=str, default="cuda", help="Choose the device to train")
    parser.add_argument("--validation", action="store_true", help="The output file will be named 'val_predictions.csv' if on")
